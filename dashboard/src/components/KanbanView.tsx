...
export function KanbanView() {
  ...
  const [newAssignee, setNewAssignee] = useState<"agent" | "user">("user");
    ...
    <div style={{ padding: 20, height: "100%", overflow: "auto", display: "flex", flexDirection: "column" as const }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 12 }}>
          <span style={{ width: 10, height: 10, borderRadius: "50%", display: "inline-block", background: ASSIGNEE_COLORS.agent.badge }} />
          <span style={{ color: theme.textMuted }}>Agent</span>
          <span style={{ width: 10, height: 10, borderRadius: "50%", display: "inline-block", background: ASSIGNEE_COLORS.user.badge, marginLeft: 12 }} />
                        ...
                        <>
                          ...
                          <div style={{ display: "flex", gap: 6, marginTop: 6 }}>
                            ...
                            <button
                              ...
                              onClick={() => updateTask(task.id, { assignee: task.assignee === "agent" ? "user" : "agent" })}
                            >
                              &rarr; {task.assignee === "agent" ? "User" : "Agent"}
                            </button>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      ...
                      <button
                        style={{
                          ...
                          fontFamily: "inherit",
                          fontWeight: 600,
                          background: newAssignee === "user" ? ASSIGNEE_COLORS.user.badge : "transparent",
                          color: newAssignee === "user" ? (isDark ? theme.bg : "#fff") : theme.textMuted,
                        }}
                      ...
                      <button
                        style={{
                          ...
                          fontFamily: "inherit",
                          fontWeight: 600,
                          background: newAssignee === "agent" ? ASSIGNEE_COLORS.agent.badge : "transparent",
                          color: newAssignee === "agent" ? (isDark ? theme.bg : "#fff") : theme.textMuted,
                        }}
